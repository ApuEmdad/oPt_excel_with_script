...
function main(
  ...
  assistance_types_food_assistance?: string,
  assistance_types_NFIs?: string,
  assistance_types_water_?: string,
  assistance_types_psychological_support?: string,
  assistance_types_medical_assistance?: string,
  assistance_types_shelter?: string,
  assistance_types_education?: string,
  assistance_types_nutrition?: string,
  assistance_types_other?: string,
  ...
  const values = [
    ...
    EmployeeName,
    AssistanceTypes,
    assistance_types_food_assistance,
    assistance_types_NFIs,
    assistance_types_water_,
    assistance_types_psychological_support,
    assistance_types_medical_assistance,
    assistance_types_shelter,
    assistance_types_education,
    assistance_types_nutrition,
    assistance_types_other,
    Otherspecifyassistance,
    Feedback,
    Breaches,
    Negative,
